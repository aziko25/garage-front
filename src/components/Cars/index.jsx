...
const Cars = () => {
  ...
  const changeRent = async (e) => {
    ...
    try {
      const response = await axios.patch(`${APP_ROUTES.URL}/car/findOne/${changeCarObj.id}`, changeCarObj, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("@token")}`,
        },
      });
    ...
    return rentalsDeshboard || sumDashboard ? (
      <>
        ...
        <div className='infoCol'>
          ...
          <p>{sumDashboard.income ? sumDashboard.income.toLocaleString("de-DE") + " uzs" : "Данных нет"}</p>
        </div>
        <div className='infoCol'>
        ...
        <div className='infoCol'>
          ...
          <p>{sumDashboard.total ? sumDashboard.total.toLocaleString("de-DE") + " uzs" : "Данных нет"}</p>
        </div>
        <div className='infoCol'>
            ...
            <div className='leftCreateRentModal'>
              <div className='modalItem'>
                ...
                <input
                  ...
                  onChange={(e) => setChangeCarObj({ ...changeCarObj, model: e.target.value })}
                />
                <input
                  type='phone'
                  placeholder='Номер авто'
            ...
            <div className='rightCreateRentModal'>
              <div className='modalItem'>
                ...
                <input
                  ...
                  onChange={(e) => setChangeCarObj({ ...changeCarObj, run: e.target.value })}
                />
                <select
                  name=''
                  id=''
                  value={changeCarObj.owner}
                  onChange={(e) => setChangeCarObj({ ...changeCarObj, owner: e.target.value })}
                >
                  <option
                    value=''
                    hidden
